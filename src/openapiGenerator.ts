import { ApiDefinitionSchema, RouteSchema } from './router/definition';
...
export function generateOpenApiSpec(definition: ApiDefinitionSchema) {
    ...
    Object.keys(definition).forEach(domainNameKey => {
        ...
        Object.keys(domain).forEach(routeNameKey => {
            ...
            const pathItem: any = {}; // Define PathItemObject structure
